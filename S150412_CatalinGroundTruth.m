...
nlim(1) = max(1, nlim(1));
mrWav = mrWav0(nlim(1):nlim(2), viChan); %trim data, flip matrix
...
%%
P = struct('sRateHz', Sfile.sRateHz*nInterp, 'nPadding', 10, 'nInterp', 1, ...
    'thresh', [], 'maxAmp', maxAmp, 'nSpkMax', 100, 'spkLim', [-20,40]*nInterp, ...
    'funcFet', [], 'vcDist', 'correlation', 'percent', .2, 'spkRemoveZscore', 4, ...
    'iCluNoise', 0, 'fNormFet', 0, 'fZscore', 0, 'vcFet', 'phase-pca', ...
    'vcFetMeas', 'vpp', 'slopeLim', [-8,12], 'mrSiteLoc', Sfile.Siteloc(:,viChan), ...
    'vcCluster', 'klustakwik', 'trimLim', [-10,30], 'nPca', 3, 'fCleanClu', 1, ...
    'fLatent', 0, 'fReclust', 0, 'fPcaMulti', 1, 'fAlign', 1, 'fPostAlign', 0, ...
    'diffOrder', 7, 'qqFactor', 3.5);
...
%% waveform average
% vpp   
%86.4184   75.7432   69.8450   74.5564   88.3368   66.2659   74.5462   74.1775   70.2995   75.8992

% vppspp   
%97.2288   74.4204   75.0361   71.0778   69.6579   65.9928   74.6983   74.7004   74.2524   81.5346
