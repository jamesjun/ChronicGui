...
%%
P = struct('sRateHz', Sfile.sRateHz*nInterp, 'nPadding', 16, 'nInterp', 1, ...
    'thresh', [], 'maxAmp', maxAmp, 'nSpkMax', 100, 'spkLim', [-1,2]*16*nInterp, ...
    'funcFet', [], 'vcDist', 'correlation', 'percent', .2, 'spkRemoveZscore', 4, ...
    'iCluNoise', 0, 'fNormFet', 0, 'fZscore', 0, 'vcFet', 'align-phase-pca', ...
    'vcFetMeas', 'vpp', 'slopeLim', [-8,12], 'mrSiteLoc', Sfile.Siteloc(:,viChan), ...
    'vcCluster', 'klustakwik', 'trimLim', [], 'nPca', 3, 'fCleanClu', 1, ...
    'fLatent', 1, 'fReclust', 1, 'fPcaMulti', 1);
